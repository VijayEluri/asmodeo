...
public class Princi implements ActionListener{
	...
	public Princi(JTextField in,int max,JFrame f,JFrame tov,JLabel num){
	this.in=in;
	this.max=max;
	this.num=num;
	this.f=f;
	...
	public Princi(JCheckBoxMenuItem cb,JButton b,JTextField in,JTextArea out,JLabel cod,JLabel num){
		this.in=in;
		this.b=b;
		this.cb=cb;
		this.out=out;
