...
import dev.macrobug.asmodeo.gui.listener.TradECpy;
...
public class NMyP extends JPanel implements ActionListener {
	...
	public NMyP(JTextField in,JButton b,boolean tasto,JLabel num,JLabel cod,JRadioButton nulla){
		...
		trad.addActionListener(new Stampa(out,this,this.cod,this.num,tasto));
		pre.addActionListener(new TradECpy(sx,out,tasto,this.cod,this.num));
