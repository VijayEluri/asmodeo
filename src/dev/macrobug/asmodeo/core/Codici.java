 ...
 *ma purtroppo non funzionano pi�, da aggiornare*/
...
public class Codici{
  ...
  public void f(String ti,String s){
    try{
      ...
      DataOutputStream d=new DataOutputStream(new FileOutputStream(fi,true));
      d.writeChars(s);
      d.writeChar(' ');
      d.writeChars(ti);
      d.writeChar('\n');
      ...
      Dialogo d=new Dialogo("Errore","Non � stato possibile salvare il nuovo set di caratteri");
      d.show();
    }
  }
}