...
import dev.macrobug.asmodeo.core.Util;
import dev.macrobug.asmodeo.gui.Calcolo;

public class CalcoDoc implements DocumentListener{
	...
	public CalcoDoc(JTextField txt,JTextField g,JTextField b,JRadioButton rb,JRadioButton[] jrb){
		out=txt;
		cod=g;
		doc=b;
		this.rb=rb;
	...
	public CalcoDoc(int i,JTextField out,JTextField g,JTextField b,JRadioButton rb,JRadioButton[] jrb){
		this(out,g,b,rb,jrb);
		this.i=i;
	}
