...
import org.macrobug.util.Reset;

import dev.macrobug.asmodeo.gui.listener.CalcoDoc;
import dev.macrobug.asmodeo.gui.listener.Calco;
import dev.macrobug.asmodeo.gui.listener.CalcoR;
import dev.macrobug.asmodeo.gui.listener.CalcoRT;
...
//
        ...
        operazioni.getDocument().addDocumentListener(new CalcoDoc(2,binF,codG,codB,in,jrb));
        operazioni.getDocument().addDocumentListener(new CalcoDoc(10,deciF,codG,codB,in,jrb));
        operazioni.getDocument().addDocumentListener(new CalcoDoc(16,esaF,codG,codB,in,jrb));
        operazioni.getDocument().addDocumentListener(new CalcoDoc(8,otaF,codG,codB,in,jrb));
        operazioni.getDocument().addDocumentListener(new CalcoDoc(userF,codG,codB,in,jrb));
        code.addActionListener(new Calco(codG,codB,code,jrb,in,operazioni));
        Reset res=new Reset(operazioni);
        for(int i=0;i<5;i++)
        	jrb[i].addActionListener(res);
        jrb[4].addActionListener(new Calco(codG,codB,code,jrb,in,operazioni));
        CalcoRT rtl=new CalcoRT(operazioni,codG,codB,jrb,in);
