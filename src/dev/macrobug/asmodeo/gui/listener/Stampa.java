...
public class Stampa implements ActionListener{
	...
	public Stampa(JTextArea area,JComponent dove,JLabel cod,JLabel num,boolean bool){
		this.area=area;
		this.dove=dove;
		this.bool=bool;
		this.cod=cod;
	...
	public Stampa(JTextArea area,JComponent dove,JLabel cod,JLabel num){
