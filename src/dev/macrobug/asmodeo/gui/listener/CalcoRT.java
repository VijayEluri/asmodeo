...
public class CalcoRT implements ActionListener{
	
	private AbstractButton[] jrb;
	private JTextField txt,g,b;
	
	public CalcoRT(JTextField txt,JTextField g,JTextField b,AbstractButton[] jrb,JRadioButton in){
		this.jrb=jrb;
		this.txt=txt;
		this.g=g;
		this.b=b;
	...
	public CalcoRT(AbstractButton[] jrb){
		this.jrb=jrb;
	}
